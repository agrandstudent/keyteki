                ...
                <Row>
                    ...
                    <Col xs='8' sm='4'>
                        <Row>
                            ...
                            <Col xs='6'>{deck.wins}</Col>
                        </Row>
                        <Row>
                            <Col xs='6'>
                                <span>Losses</span>
                            </Col>
                            <Col xs='6'>{deck.losses}</Col>
                        </Row>
                        <Row>
                            <Col xs='6'>
                                <span>Total</span>
                            </Col>
                            <Col xs='6'>{parseInt(deck.wins) + parseInt(deck.losses)}</Col>
                        </Row>
                        <Row>
                            <Col xs='6'>
                                <span>Win Rate</span>
                            </Col>
                            <Col xs='6'>{deck.winRate}</Col>
                        </Row>
                    </Col>
                </Row>
                ...
                <Row className='deck-cards'>
                    {deck.houses.map((house) => {
                        return (
                            <Col key={house} sm='4'>
                                {deck.cards
                                    .filter((c) => c.card.house === house)
                                    .map((card) => (
                                        <div key={card.id}>{card.card.name}</div>
                                    ))}
                            </Col>
                        );
                    })}
